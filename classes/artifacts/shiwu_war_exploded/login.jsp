...
<head>
    ...
    {
	   margin-left: 0px;
	   background-image: url(<%=path %>/img/bj1.jpeg);
    }
    .style2 {color: #990000}
    .input2 
    {
    ...
    .STYLE15 {color: #0E3460; font-size: 9pt; }
 </style>
...
<body>
	...
	<br>
	<br>
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  background=white>
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 37pt;">学生会日常事务管理系统</div></td>
	 </tr>
	 <tr>
		<td width="559">
			<form name="ThisForm" method="POST" action="">
				<table width="490" height="198" border="0" align="center" cellpadding="0" cellspacing="0">
					<tbody align="center">
					<tr>
